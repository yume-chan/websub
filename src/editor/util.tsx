...
export function indexed(element: 'input'): React.FunctionComponent<IndexedComponentProps<React.InputHTMLAttributes<HTMLInputElement>>>;
export function indexed<T extends keyof React.ReactHTML>(element: T): React.FunctionComponent<IndexedComponentProps<React.HTMLAttributes<T>>>;
export function indexed<TProps>(Component: React.FunctionComponent<TProps>): React.FunctionComponent<IndexedComponentProps<TProps>>;
export function indexed<TProps>(Component: string | React.FunctionComponent<TProps>): React.FunctionComponent<any> {
    function IndexedComponent(props: IndexedComponentProps<TProps>) {
        ...
        return React.createElement(Component, mappedPropsRef.current);
    }

    if (typeof Component === 'string') {
        IndexedComponent.displayName = `Indexed(${Component})`;
    } else {
